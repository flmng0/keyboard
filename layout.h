...
#define _BASE \
  ...
  KC_Z   , KZ_X   , KC_C   , KC_D   , KC_V   , KC_K   , KC_H   , KC_COMM, KC_DOT , KC_QUOT, \
...
#define _SYM \
  ...
  KC_TILD, KC_GRV , KC_DQUO, KC_BSLS, KC_NO  , CT_ENT , KC_PIPE, KC_PLUS, KC_MINS, KC_QUES, \
  KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, KC_NO  , KC_NO  , KC_RCTL, KC_RSFT, KC_LALT, KC_RGUI, \
                             L_NAV  , KC_TRNS, KC_TRNS, KC_TRNS

#define _NUM \
  KC_NO  , KC_F7  , KC_F8  , KC_F9  , KC_F12 , KC_RET , KC_7   , KC_8   , KC_9   , D_GAME , \
